...
new_projects_section = """    <!-- FEATURED -->
    <div class="featured">
      ...
      <a class="card featured-card fade-in" href="projects/l1-adaptive-control-uav.html" data-cats="drone software">
        <div class="card-top">
          <span class="card-num">02 / THESIS</span>
          <span class="card-badge research">Research · STM32F407</span>
        </div>
        <h3><span class="glyph">◈</span>HIL Testing Adaptive L1 Control for UAV Heavy Payload Drop on STM32F407 (Pixhawk)</h3>
        <p>Implementation &amp; Hardware-in-the-Loop (HIL) testing of an L1 Adaptive Controller for quadrotors undergoing sudden mass shedding and unmodeled disturbances. Carried from SITL in MATLAB to SITL in ROS and HIL on STM32F407 Pixhawk hardware.</p>
        <div class="stack-tags">
          <span class="t">MATLAB</span><span class="t">ROS</span><span class="t">C++</span>
          <span class="t">STM32F407</span><span class="t">Pixhawk</span><span class="t">ArduPilot</span>
    ...
    <div class="more-list" id="moreList">
      <ul>
        <li><a href="projects/pcb-reflow-conveyor-cv-sorting.html" class="more-item-link"><span class="idx">11</span><span class="name">PCB Reflow Heating Conveyor System with Defect Sorting through Computer Vision</span><span class="tools">OpenCV · STM32 ↗</span></a></li>
        <li><a href="projects/hourglass-atmega328p-pcb.html" class="more-item-link"><span class="idx">12</span><span class="name">Hourglass PCB with ATmega328P</span><span class="tools">KiCad · MPU6050 ↗</span></a></li>
        <li><a href="projects/mini-logic-analyzer.html" class="more-item-link"><span class="idx">13</span><span class="name">Mini Logic Analyzer</span><span class="tools">STM32 · 24MHz DMA ↗</span></a></li>
        <li><a href="projects/batik-coagulant-unit.html" class="more-item-link"><span class="idx">14</span><span class="name">Batik Coagulant Modular Processing Unit</span><span class="tools">SolidWorks ↗</span></a></li>
        <li><a href="projects/funbox-controller.html" class="more-item-link"><span class="idx">15</span><span class="name">FunBox Controller</span><span class="tools">IoT · ESP32 ↗</span></a></li>
        <li><a href="projects/humanoid-robot-dance.html" class="more-item-link"><span class="idx">16</span><span class="name">Humanoid Robot Dance</span><span class="tools">C# · 3D CAD ↗</span></a></li>
        <li><a href="projects/wind-turbine-3d-model.html" class="more-item-link"><span class="idx">17</span><span class="name">Wind Turbine 3D Model</span><span class="tools">SolidWorks ↗</span></a></li>
      </ul>
    </div>"""
...
for filepath in files_to_update:
    ...
    start_tag = "<!-- FEATURED -->"
    end_tag = "<!-- LEARNING JOURNAL -->"
    
    if start_tag in content and end_tag in content:
        p1 = content.find(start_tag)
        p2 = content.find(end_tag)
        
        # Replace between p1 and p2
        before = content[:p1]
        after = content[p2:]
        
        new_content = before + new_projects_section + "\n  </div>\n</section>\n\n" + after
        
        with open(filepath, "w", encoding="utf-8") as f:
            f.write(new_content)
        print(f"Updated {filepath}")
    else:
        print(f"Could not locate bounds in {filepath}")

print("Homepage update for 17 projects completed.")
